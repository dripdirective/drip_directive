              ...
              <>
                ...
                {metadata.summary_text && (
                  <View style={styles.detailSection}>
                    ...
                    <Text style={styles.summaryText}>{metadata.summary_text}</Text>
                  </View>
                )}
              </>
            ) : (
          ...
          <View style={styles.metadataContainer}>
            ...
            {metadata.occasion && (
              <View style={styles.tagsRow}>
                {(Array.isArray(metadata.occasion) ? metadata.occasion.slice(0, 2) : [metadata.occasion]).map((occ, idx) => (
                  <View key={idx} style={styles.tagChip}>
                    <Text style={styles.tagText}>{occ}</Text>
                  </View>
                ))}
                {Array.isArray(metadata.occasion) && metadata.occasion.length > 2 && (
                  <View style={[styles.tagChip, { backgroundColor: COLORS.textMuted + '30' }]}>
                    <Text style={styles.tagText}>+{metadata.occasion.length - 2}</Text>
                  </View>
                )}
              </View>
            )}
