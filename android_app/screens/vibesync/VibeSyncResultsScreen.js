...
const calculateArchetype = (scores) => {
    ...
    // Simple logic matching the web UX
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.resultCard}>
                    ...
                    <View style={styles.dnaSection}>
                        <StatRow label="Minimal ↔ Maximal" value={aestheticPct} color="#667eea" />
                        <StatRow label="Authority ↔ Security" value={comfortPct} color="#764ba2" />
                        <StatRow label="Structure ↔ Organic" value={patternPct} color="#f093fb" />
                    </View>
